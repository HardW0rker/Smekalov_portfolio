...
export default {
  ...
  methods:{
    ...
    download_file(item){
      axios
      .post(path.path_list_files(),{
        document_id: this.data.document_id
      })
      .then(response => (
        this.new_data.documents = response.data),
        console.log(this.new_data))
      .catch(function (error) {
        console.log(error);
      });
      console.log(item)
      axios.get( path.path_get_files(),
        {params:
          {
    ...
    addfile(event){
      ...
      this.new_data.documents.push({'filename':this.file.name})
      this.new_data.documents.push({'filename':this.file.name})
